...
namespace mscl
{
    ...
    //Class: FieldParser_GnssSBASInfo
    //    The field parser for SBAS Status data
    class FieldParser_GnssSBASInfo : public MipGnssFieldParser
    {
        ...
        //Constructor: FieldParser_GnssSBASInfo
    ...
    //Class: FieldParser_GnssRFErrorDetection
    //    The field parser for GNSS Error Detection subsystem status
    class FieldParser_GnssRFErrorDetection : public MipGnssFieldParser
    {
        //Constants: Valid Flag Bitmasks
        //
        //    RF_BAND_VALID  - 0x01 - RF Band flag mask
        //    JAMMING_VALID  - 0x02 - Jamming State flag mask
        //    SPOOFING_VALID - 0x04 - Spoofing State flag mask
        static constexpr uint16 RF_BAND_VALID  = 0x01; // RF Band flag mask
        static constexpr uint16 JAMMING_VALID  = 0x02; // Jamming State flag mask
        static constexpr uint16 SPOOFING_VALID = 0x04; // Spoofing State flag mask

        //Constructor: FieldParser_GnssRFErrorDetection
        //    Default constructor disabled
